...
COMPONENT_INCLUDES += $(PROJECT_PATH)/include/
...
COMMON_WARNING_FLAGS = -Wall -Werror \
	...
	-Wpointer-arith -Wno-error=char-subscripts -Wno-error=maybe-uninitialized -Wno-error=parentheses -Wno-error=return-type -Wno-error=unused-value -Wno-error=enum-compare -Wno-error=format=	\
...
CFLAGS := $(strip \
	...
	$(CFLAGS))	\
	-DLUA_OPTIMIZE_MEMORY=2 -DMIN_OPT_LEVEL=2 -DCONFIG_BUILD_SPIFFS
