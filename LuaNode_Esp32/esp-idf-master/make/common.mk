...
CFLAGS = -DESP_PLATFORM -Og -std=gnu99 -g3 \
	-Wpointer-arith -Werror -Wno-error=unused-function -Wno-error=unused-but-set-variable -Wno-error=unused-variable -Wno-error=char-subscripts -Wno-error=maybe-uninitialized -Wno-error=parentheses -Wno-error=return-type -Wno-error=unused-value -Wno-error=enum-compare -Wno-error=format=\
	-Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -Wall -ffunction-sections -fdata-sections $(EXTRA_CFLAGS)	\
	-DLUA_OPTIMIZE_MEMORY=2 -DMIN_OPT_LEVEL=2
endif
