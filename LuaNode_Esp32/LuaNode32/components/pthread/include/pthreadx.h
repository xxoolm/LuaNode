...
typedef struct pthread_mutex_attr _pthread_mutexattr_t;
...
typedef unsigned int _pthread_condattr_t;
...
typedef struct pthread_cond _pthread_cond_t;

struct pthread_once {
    struct mtx mutex;
};

typedef struct pthread_once _pthread_once_t;
...
typedef struct pthread_attr _pthread_attr_t;
...
void _pthread_init();
int _pthread_create(_pthread_t *id, int stacksize, int initial_state, void *(*start_routine)(void *), void *args);
...
int pthread_cond_timedwait(_pthread_cond_t *cond, pthread_mutex_extend_t *mutex, const struct timespec *abstime);
