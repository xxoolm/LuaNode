...
int ets_strcasecmp(const char *s1, const char *s2);
int ets_strncasecmp(const char *s1, const char *s2, size_t n);
...
//Standard PIN_FUNC_SELECT gives a warning. Replace by a non-waring one.
