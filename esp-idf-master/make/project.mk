...
ALL_COMPONENTS_DIRS ?= $(PROJECT_PATH)/components $(EXTRA_COMPONENT_DIRS) $(IDF_PATH)/components
export ALL_COMPONENTS_DIRS
...
COMPONENT_PATHS := $(foreach comp,$(COMPONENTS),$(firstword $(foreach dir,$(ALL_COMPONENTS_DIRS),$(wildcard $(dir)/$(comp)))))
