...
static ble_hs_hci_evt_le_fn ble_hs_hci_evt_le_data_len_changed;
...
static ble_hs_hci_evt_le_fn * const ble_hs_hci_evt_le_dispatch[] = {
    ...
    [BLE_HCI_LE_SUBEV_DATA_LEN_CHG] = ble_hs_hci_evt_le_data_len_changed,
...
static int
ble_hs_hci_evt_le_data_len_changed(uint8_t subevent, const void *data, unsigned int len)
{
    ...
    BLE_HS_DBG_ASSERT(le16toh(ev->max_tx_octets) >= BLE_HCI_SET_DATALEN_TX_OCTETS_MIN);
