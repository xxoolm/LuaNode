...
#define OI_MemCopy(to, from, size)    wm_memcpy((to), (from), (size))
#define OI_MemSet(block, val, size)   wm_memset((block), (val), (size))
#define OI_MemZero(block, size)       wm_memset((block), 0, (size))
