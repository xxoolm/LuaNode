...
** Returns          void.
******************************************************************************/
extern void A2D_BldSbcMplHdr(uint8_t *p_dst, uint8_t frag, uint8_t start,
                             uint8_t last, uint8_t num);
...
** Returns          void.
******************************************************************************/
extern void A2D_ParsSbcMplHdr(uint8_t *p_src, uint8_t *p_frag,
                              uint8_t *p_start, uint8_t *p_last,
                              uint8_t *p_num);
#ifdef __cplusplus
}
#endif
