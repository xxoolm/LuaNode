...
extern int RFCOMM_CreateConnection(uint16_t uuid, uint8_t scn,
                                   uint8_t is_server, uint16_t mtu,
...
**
*******************************************************************************/
extern uint8_t PORT_IsOpening(BD_ADDR bd_addr);
...
**
*******************************************************************************/
extern int PORT_FlowControl(uint16_t handle, uint8_t enable);
