...
typedef struct
{
    ...
    uint8_t         is_prep;    /* is prepare write */
} tGATT_WRITE_REQ;
...
typedef void (tGATT_CONN_CBACK)(tGATT_IF gatt_if, BD_ADDR bda, uint16_t conn_id, uint8_t connected,
...
typedef void (tGATT_CONGESTION_CBACK)(uint16_t conn_id, uint8_t congested);
...
typedef struct
{
    ...
    uint16_t   s_handle;
    uint16_t   e_handle;
    uint8_t  is_primary;      /* primary service or secondary */
} tGATTS_HNDL_RANGE;
...
*/
typedef void (tGATTS_NV_SAVE_CBACK)(uint8_t is_saved, tGATTS_HNDL_RANGE *p_hndl_range);
...
extern uint8_t GATTS_AddHandleRange(tGATTS_HNDL_RANGE *p_hndl_range);
...
**
*******************************************************************************/
extern uint8_t  GATTS_NVRegister(tGATT_APPL_INFO *p_cb_info);
...
**
*******************************************************************************/
extern uint16_t GATTS_CreateService(tGATT_IF gatt_if, tBT_UUID *p_svc_uuid,
...
**
*******************************************************************************/
extern uint16_t GATTS_AddIncludeService(uint16_t service_handle,
                                        uint16_t include_svc_handle);
...
**
*******************************************************************************/
extern uint16_t GATTS_AddCharacteristic(uint16_t service_handle, tBT_UUID *char_uuid,
...
**
*******************************************************************************/
extern uint16_t GATTS_AddCharDescriptor(uint16_t service_handle, tGATT_PERM perm,
...
**
*******************************************************************************/
extern uint8_t GATTS_DeleteService(tGATT_IF gatt_if, tBT_UUID *p_svc_uuid,
                                   uint16_t svc_inst);
...
**
*******************************************************************************/
extern tGATT_STATUS GATTS_StartService(tGATT_IF gatt_if, uint16_t service_handle,
...
**
*******************************************************************************/
extern tGATT_STATUS GATTC_ExecuteWrite(uint16_t conn_id, uint8_t is_execute);
...
**
*******************************************************************************/
extern uint8_t GATT_Connect(tGATT_IF gatt_if, BD_ADDR bd_addr,
                            uint8_t is_direct, tBT_TRANSPORT transport);
...
**
*******************************************************************************/
extern uint8_t GATT_CancelConnect(tGATT_IF gatt_if, BD_ADDR bd_addr,
                                  uint8_t is_direct);
...
**
*******************************************************************************/
extern uint8_t GATT_GetConnectionInfor(uint16_t conn_id, tGATT_IF *p_gatt_if,
...
**
*******************************************************************************/
extern uint8_t GATT_GetConnIdIfConnected(tGATT_IF gatt_if, BD_ADDR bd_addr,
...
**
*******************************************************************************/
extern uint8_t GATT_Listen(tGATT_IF gatt_if, uint8_t start, BD_ADDR_PTR bd_addr);
...
**
*******************************************************************************/
extern void GATT_ConfigServiceChangeCCC(BD_ADDR remote_bda, uint8_t enable,
