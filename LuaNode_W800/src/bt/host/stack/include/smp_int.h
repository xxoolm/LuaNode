...
typedef struct
{
    ...
    uint8_t le_sc_kp_notif_is_used;
...
extern void  smp_set_fail_nc(uint8_t enable);
extern void  smp_set_fail_conf(uint8_t enable);
extern void  smp_set_passk_entry_fail(uint8_t enable);
extern void  smp_set_oob_fail(uint8_t enable);
extern void  smp_set_peer_sc_notif(uint8_t enable);
...
/* smp_util.c */
extern uint8_t smp_send_cmd(uint8_t cmd_code, tSMP_CB *p_cb);
...
extern uint8_t smp_encrypt_data(uint8_t *key, uint8_t key_len,
                                uint8_t *plain_text, uint8_t pt_len,
                                tSMP_ENC *p_out);
extern uint8_t smp_command_has_invalid_parameters(tSMP_CB *p_cb);
...
extern uint8_t smp_check_commitment(tSMP_CB *p_cb);
extern void smp_save_secure_connections_long_term_key(tSMP_CB *p_cb);
extern uint8_t smp_calculate_f5_mackey_and_long_term_key(tSMP_CB *p_cb);
extern void smp_remove_fixed_channel(tSMP_CB *p_cb);
extern uint8_t smp_request_oob_data(tSMP_CB *p_cb);
...
extern uint8_t smp_calculate_link_key_from_long_term_key(tSMP_CB *p_cb);
extern uint8_t smp_calculate_long_term_key_from_link_key(tSMP_CB *p_cb);
...
extern uint8_t smp_calculate_f5(uint8_t *w, uint8_t *n1, uint8_t *n2, uint8_t *a1, uint8_t *a2,
                                uint8_t *mac_key, uint8_t *ltk);
extern uint8_t smp_calculate_f5_mackey_or_long_term_key(uint8_t *t, uint8_t *counter,
        uint8_t *key_id, uint8_t *n1, uint8_t *n2, uint8_t *a1,
        uint8_t *a2, uint8_t *length, uint8_t *mac);
extern uint8_t smp_calculate_f5_key(uint8_t *w, uint8_t *t);
extern uint8_t smp_calculate_f6(uint8_t *w, uint8_t *n1, uint8_t *n2, uint8_t *r, uint8_t *iocap,
                                uint8_t *a1, uint8_t *a2, uint8_t *f3);
extern uint8_t smp_calculate_h6(uint8_t *w, uint8_t *keyid, uint8_t *h2);
#if SMP_DEBUG == TRUE
