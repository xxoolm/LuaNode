...
typedef struct
{
    ...
    uint8_t             cong;           /* TRUE, if congested */
} tAVCT_LCB;
...
typedef struct
{
    ...
    uint8_t             ch_close;           /* Whether CCB initiated channel close */
...
extern uint8_t avct_lcb_last_ccb(tAVCT_LCB *p_lcb, tAVCT_CCB *p_ccb_last);
