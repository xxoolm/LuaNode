...
typedef struct
{
    ...
    uint8_t             appl_knows_rem_name;    /* set by application if it knows the remote name of the peer device.
...
*/
typedef void (tBTM_INQ_DB_CHANGE_CB)(void *p1, uint8_t is_new);
...
typedef void (tBTM_ACL_DB_CHANGE_CB)(BD_ADDR p_bda, DEV_CLASS p_dc,
                                     ...
                                     uint8_t is_new, uint16_t handle,
...
** SCO Routing Path
********************/
#define BTM_SCO_ROUTE_PCM           0x0000
#define BTM_SCO_ROUTE_HCI           0x0001
...
typedef uint8_t (tBTM_AUTHORIZE_CALLBACK)(BD_ADDR bd_addr, DEV_CLASS dev_class,
        ...
        uint8_t service_id, uint8_t is_originator);
...
typedef uint8_t (tBTM_PIN_CALLBACK)(BD_ADDR bd_addr, DEV_CLASS dev_class,
                                    tBTM_BD_NAME bd_name, uint8_t min_16_digit);
...
typedef struct
{
    ...
    uint8_t         is_orig;        /* TRUE, if local device initiated the SP process */
} tBTM_SP_IO_REQ;
...
{
    BD_ADDR         bd_addr;        /* peer address */
    uint8_t         upgrade;        /* TRUE, to upgrade the link key */
} tBTM_SP_UPGRADE;
...
typedef uint8_t (tBTM_MIP_QUERY_CB)(BD_ADDR dev_addr, uint8_t *p_mode, LINK_KEY link_key);
...
**
*******************************************************************************/
extern uint8_t BTM_IsDeviceUp(void);
...
**
*******************************************************************************/
extern tBTM_STATUS BTM_RegisterForVSEvents(tBTM_VS_EVT_CB *p_cb, uint8_t is_register);
...
**
*******************************************************************************/
extern uint8_t BTM_TryAllocateSCN(uint8_t scn);
...
**
*******************************************************************************/
extern uint8_t BTM_FreeSCN(uint8_t scn);
...
**
*******************************************************************************/
extern uint8_t BTM_IsAclConnectionUp(BD_ADDR remote_bda, tBT_TRANSPORT transport);
...
**
*******************************************************************************/
extern tBTM_STATUS BTM_CreateSco(BD_ADDR remote_bda, uint8_t is_orig,
...
**
*******************************************************************************/
extern uint8_t BTM_SecRegister(tBTM_APPL_INFO *p_cb_info);
...
**
*******************************************************************************/
extern uint8_t BTM_SecRegisterLinkKeyNotificationCallback(
...
**
*******************************************************************************/
extern uint8_t BTM_SecAddRmtNameNotifyCallback(tBTM_RMT_NAME_CALLBACK *p_callback);
...
**
*******************************************************************************/
extern uint8_t BTM_SecDeleteRmtNameNotifyCallback(tBTM_RMT_NAME_CALLBACK *p_callback);
...
**
*******************************************************************************/
extern uint8_t BTM_GetSecurityFlags(BD_ADDR bd_addr, uint8_t *p_sec_flags);
...
**
*******************************************************************************/
extern uint8_t BTM_GetSecurityFlagsByTransport(BD_ADDR bd_addr,
...
**
*******************************************************************************/
extern void BTM_SetSecureConnectionsOnly(uint8_t secure_connections_only_mode);
...
**
*******************************************************************************/
extern uint8_t BTM_SetSecurityLevel(uint8_t is_originator, char *p_name,
...
**
*******************************************************************************/
extern uint8_t BTM_SecAddDevice(BD_ADDR bd_addr, DEV_CLASS dev_class,
...
**
*******************************************************************************/
extern uint8_t BTM_SecDeleteDevice(BD_ADDR bd_addr);
...
**
*******************************************************************************/
extern uint8_t BTM_BothEndsSupportSecureConnections(BD_ADDR bd_addr);
...
**
*******************************************************************************/
extern uint8_t BTM_PeerSupportsSecureConnections(BD_ADDR bd_addr);
...
**
*******************************************************************************/
extern uint8_t BTM_HasEirService(uint32_t *p_eir_uuid, uint16_t uuid16);
...
**
*******************************************************************************/
extern void BTM_PCM2Setup_Write(uint8_t clk_master, tBTM_VSC_CMPL_CB *p_arc_cb);
...
**
** Description      This function is called to obtain the controller advertisement state
**
** Returns          
**
*******************************************************************************/

extern uint8_t BTM_IsBleAdvertiseActive(void);

/*******************************************************************************
**
** Function         BTM_IsScanActive
**
** Description      This function is called to obtain the controller scan state
**
** Returns          
**
*******************************************************************************/

extern uint8_t BTM_IsBleScanActive(void);
#ifdef __cplusplus
}
#endif
