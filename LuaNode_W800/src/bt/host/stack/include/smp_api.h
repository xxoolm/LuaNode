...
#define SMP_AUTH_NB_ENC_ONLY    (SMP_AUTH_MASK | BTM_AUTH_SP_NO)
...
** Function         SMP_Init
**
** Description      This function frees the SMP unit.
**
** Returns          void
**
*******************************************************************************/
...
**
*******************************************************************************/
extern uint8_t SMP_Register(tSMP_CALLBACK *p_cback);
...
**
*******************************************************************************/
extern  uint8_t SMP_PairCancel(BD_ADDR bd_addr);
...
*******************************************************************************/
extern uint8_t SMP_Encrypt(uint8_t *key, uint8_t key_len,
...
*******************************************************************************/
extern uint8_t SMP_CreateLocalSecureConnectionsOobData(
