...
**
*******************************************************************************/
uint8_t SDP_InitDiscoveryDb(tSDP_DISCOVERY_DB *p_db, uint32_t len,
                            uint16_t num_uuid,
...
**
*******************************************************************************/
uint8_t SDP_ServiceSearchRequest(uint8_t *p_bd_addr,
...
**
*******************************************************************************/
uint8_t SDP_ServiceSearchAttributeRequest(uint8_t *p_bd_addr,
        tSDP_DISCOVERY_DB *p_db,
        tSDP_DISC_CMPL_CB *p_cb);
...
**
*******************************************************************************/
uint8_t SDP_ServiceSearchAttributeRequest2(uint8_t *p_bd_addr,
        tSDP_DISCOVERY_DB *p_db,
...
**
*******************************************************************************/
uint8_t SDP_FindProtocolListElemInRec(tSDP_DISC_REC *p_rec,
                                      uint16_t layer_uuid,
...
**
*******************************************************************************/
uint8_t SDP_FindAddProtoListsElemInRec(tSDP_DISC_REC *p_rec,
                                       uint16_t layer_uuid,
                                       tSDP_PROTOCOL_ELEM *p_elem);
...
**
*******************************************************************************/
uint8_t SDP_FindProfileVersionInRec(tSDP_DISC_REC *p_rec,
...
**
*******************************************************************************/
uint8_t SDP_AddSequence(uint32_t handle,  uint16_t attr_id,
...
**
*******************************************************************************/
uint8_t SDP_AddProfileDescriptorList(uint32_t handle,
                                     uint16_t profile_uuid,
                                     uint16_t version);
...
**
*******************************************************************************/
uint8_t SDP_AddLanguageBaseAttrIDList(uint32_t handle,
...
**
*******************************************************************************/
uint8_t SDP_AddServiceClassIdList(uint32_t handle,
