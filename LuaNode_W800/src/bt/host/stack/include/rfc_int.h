...
typedef struct
{
    ...
    uint8_t   peer_rx_disabled;              /* If TRUE peer sent FCOFF */
...
extern void rfc_process_pn(tRFC_MCB *p_rfc_mcb, uint8_t is_command, MX_FRAME *p_frame);
extern void rfc_process_msc(tRFC_MCB *p_rfc_mcb, uint8_t is_command, MX_FRAME *p_frame);
extern void rfc_process_rpn(tRFC_MCB *p_rfc_mcb, uint8_t is_command, uint8_t is_request, MX_FRAME *p_frame);
extern void rfc_process_rls(tRFC_MCB *p_rfc_mcb, uint8_t is_command, MX_FRAME *p_frame);
...
extern void rfc_process_fcon(tRFC_MCB *p_rfc_mcb, uint8_t is_command);
extern void rfc_process_fcoff(tRFC_MCB *p_rfc_mcb, uint8_t is_command);
extern void rfc_process_l2cap_congestion(tRFC_MCB *p_mcb, uint8_t is_congested);

/*
** Functions provided by the rfc_utils.c
*/
tRFC_MCB  *rfc_alloc_multiplexer_channel(BD_ADDR bd_addr, uint8_t is_initiator);
...
uint8_t   rfc_check_uih_fcs(uint8_t dlci, uint8_t received_fcs);
uint8_t   rfc_check_fcs(uint16_t len, uint8_t *p, uint8_t received_fcs);
...
extern void     rfc_send_dm(tRFC_MCB *p_rfc_mcb, uint8_t dlci, uint8_t pf);
extern void     rfc_send_disc(tRFC_MCB *p_rfc_mcb, uint8_t dlci);
extern void     rfc_send_pn(tRFC_MCB *p_mcb, uint8_t dlci, uint8_t is_command, uint16_t mtu,
                            uint8_t cl, uint8_t k);
extern void     rfc_send_test(tRFC_MCB *p_rfc_mcb, uint8_t is_command, BT_HDR *p_buf);
extern void     rfc_send_msc(tRFC_MCB *p_mcb, uint8_t dlci, uint8_t is_command,
                             tPORT_CTRL *p_pars);
extern void     rfc_send_rls(tRFC_MCB *p_mcb, uint8_t dlci, uint8_t is_command, uint8_t status);
extern void     rfc_send_rpn(tRFC_MCB *p_mcb, uint8_t dlci, uint8_t is_command,
                             tPORT_STATE *p_pars, uint16_t mask);
extern void     rfc_send_fcon(tRFC_MCB *p_mcb, uint8_t is_command);
extern void     rfc_send_fcoff(tRFC_MCB *p_mcb, uint8_t is_command);
...
extern void PORT_FlowInd(tRFC_MCB *p_mcb, uint8_t dlci, uint8_t fc);
