...
void avct_l2c_disconnect_ind_cback(uint16_t lcid, uint8_t ack_needed);
void avct_l2c_disconnect_cfm_cback(uint16_t lcid, uint16_t result);
void avct_l2c_congestion_ind_cback(uint16_t lcid, uint8_t is_congested);
...
**
*******************************************************************************/
static uint8_t avct_l2c_is_passive(tAVCT_LCB *p_lcb)
{
