...
**
*******************************************************************************/
static uint8_t gatt_sign_data(tGATT_CLCB *p_clcb)
{
    ...
    p_data = (uint8_t *)GKI_getbuf(p_attr->len + 3);     /* 3 = 2 byte handle + opcode */
    p = p_data;
...
**
*******************************************************************************/
void gatt_sec_check_complete(uint8_t sec_check_ok, tGATT_CLCB   *p_clcb, uint8_t sec_act)
{
...
tGATT_SEC_ACTION gatt_determine_sec_act(tGATT_CLCB *p_clcb)
{
    ...
    uint8_t             is_link_key_known = FALSE;
...
**
** Returns          uint8_t TRUE - conversation is successful
**
*******************************************************************************/
static uint8_t gatt_convert_sec_action(tGATT_SEC_ACTION gatt_sec_act, tBTM_BLE_SEC_ACT *p_btm_sec_act)
{
    uint8_t status = TRUE;
...
**
*******************************************************************************/
uint8_t gatt_security_check_start(tGATT_CLCB *p_clcb)
{
    tGATT_TCB           *p_tcb = p_clcb->p_tcb;
