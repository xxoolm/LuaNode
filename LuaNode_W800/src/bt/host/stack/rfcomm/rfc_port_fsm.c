...
**
*******************************************************************************/
void rfc_process_pn(tRFC_MCB *p_mcb, uint8_t is_command, MX_FRAME *p_frame)
{
    tPORT *p_port;
...
**
*******************************************************************************/
void rfc_process_rpn(tRFC_MCB *p_mcb, uint8_t is_command,
                     uint8_t is_request, MX_FRAME *p_frame)
{
...
**
*******************************************************************************/
void rfc_process_msc(tRFC_MCB *p_mcb, uint8_t is_command, MX_FRAME *p_frame)
{
    tPORT_CTRL pars;
    tPORT      *p_port;
...
**
*******************************************************************************/
void rfc_process_rls(tRFC_MCB *p_mcb, uint8_t is_command, MX_FRAME *p_frame)
{
    tPORT *p_port;
...
**
*******************************************************************************/
void rfc_process_l2cap_congestion(tRFC_MCB *p_mcb, uint8_t is_congested)
{
