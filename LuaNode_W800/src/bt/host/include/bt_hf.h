 ...
 */
typedef void (* bthf_audio_state_callback)(bthf_audio_state_t state, tls_bt_addr_t *bd_addr);

/** Callback for VR connection state change.
 *  state will have one of the values from BtHfVRState
 */
typedef void (* bthf_vr_cmd_callback)(bthf_vr_state_t state, tls_bt_addr_t *bd_addr);

/** Callback for answer incoming call (ATA)
 */
typedef void (* bthf_answer_call_cmd_callback)(tls_bt_addr_t *bd_addr);

/** Callback for disconnect call (AT+CHUP)
 */
typedef void (* bthf_hangup_call_cmd_callback)(tls_bt_addr_t *bd_addr);
 ...
 */
typedef void (* bthf_dial_call_cmd_callback)(char *number, tls_bt_addr_t *bd_addr);

/** Callback for sending DTMF tones
 *  tone contains the dtmf character to be sent
 */
typedef void (* bthf_dtmf_cmd_callback)(char tone, tls_bt_addr_t *bd_addr);

/** Callback for enabling/disabling noise reduction/echo cancellation
 *  value will be 1 to enable, 0 to disable
 */
typedef void (* bthf_nrec_cmd_callback)(bthf_nrec_t nrec, tls_bt_addr_t *bd_addr);

/** Callback for AT+BCS and event from BAC
 *  WBS enable, WBS disable
 */
typedef void (* bthf_wbs_callback)(bthf_wbs_config_t wbs, tls_bt_addr_t *bd_addr);

/** Callback for call hold handling (AT+CHLD)
 *  value will contain the call hold command (0, 1, 2, 3)
 */
typedef void (* bthf_chld_cmd_callback)(bthf_chld_type_t chld, tls_bt_addr_t *bd_addr);

/** Callback for CNUM (subscriber number)
 */
typedef void (* bthf_cnum_cmd_callback)(tls_bt_addr_t *bd_addr);

/** Callback for indicators (CIND)
 */
typedef void (* bthf_cind_cmd_callback)(tls_bt_addr_t *bd_addr);

/** Callback for operator selection (COPS)
 */
typedef void (* bthf_cops_cmd_callback)(tls_bt_addr_t *bd_addr);

/** Callback for call list (AT+CLCC)
 */
typedef void (* bthf_clcc_cmd_callback)(tls_bt_addr_t *bd_addr);

/** Callback for unknown AT command recd from HF
 *  at_string will contain the unparsed AT string
 */
typedef void (* bthf_unknown_at_cmd_callback)(char *at_string, tls_bt_addr_t *bd_addr);
...
typedef struct
{
     ...
     */
    tls_bt_status_t (*init)(bthf_callbacks_t *callbacks, int max_hf_clients);
    ...
    tls_bt_status_t (*connect_audio)(tls_bt_addr_t *bd_addr);

    /** close the audio connection */
    tls_bt_status_t (*disconnect_audio)(tls_bt_addr_t *bd_addr);

    /** start voice recognition */
    tls_bt_status_t (*start_voice_recognition)(tls_bt_addr_t *bd_addr);

    /** stop voice recognition */
    tls_bt_status_t (*stop_voice_recognition)(tls_bt_addr_t *bd_addr);
    ...
    */
    ...
    tls_bt_status_t (*configure_wbs)(tls_bt_addr_t *bd_addr, bthf_wbs_config_t config);
} bthf_interface_t;
