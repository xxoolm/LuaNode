...
typedef void (* btrc_remote_features_callback)(tls_bt_addr_t *bd_addr,
...
typedef struct
{
     ...
     */
    tls_bt_status_t (*init)(btrc_callbacks_t *callbacks);
    ...
    */
    tls_bt_status_t (*list_player_app_attr_rsp)(int num_attr, btrc_player_attr_t *p_attrs);
    ...
    */
    tls_bt_status_t (*list_player_app_value_rsp)(int num_val, uint8_t *p_vals);

    /** Returns the current application attribute values for each of the specified attr_id */
    tls_bt_status_t (*get_player_app_value_rsp)(btrc_player_settings_t *p_vals);
    ...
    */
    tls_bt_status_t (*get_player_app_attr_text_rsp)(int num_attr, btrc_player_setting_text_t *p_attrs);

    /** Returns the application attributes text ("Shuffle"/"Repeat"/...)
    **  num_attr: Specifies the number of attribute values' text contained in the pointer p_vals
    */
    tls_bt_status_t (*get_player_app_value_text_rsp)(int num_val, btrc_player_setting_text_t *p_vals);

    /** Returns the current songs' element attributes text ("Title"/"Album"/"Artist")
    **  num_attr: Specifies the number of attributes' text contained in the pointer p_attrs
    */
    tls_bt_status_t (*get_element_attr_rsp)(uint8_t num_attr, btrc_element_attr_val_t *p_attrs);
    ...
    */
    tls_bt_status_t (*set_player_app_value_rsp)(btrc_status_t rsp_status);
    ...
    */
    tls_bt_status_t (*register_notification_rsp)(btrc_event_id_t event_id,
    ...
    */
    tls_bt_status_t (*set_volume)(uint8_t volume);
...
typedef void (* btrc_connection_state_callback)(uint8_t state, tls_bt_addr_t *bd_addr);
...
typedef void (* btrc_ctrl_playerapplicationsetting_callback)(tls_bt_addr_t *bd_addr,
        uint8_t num_attr,
        btrc_player_app_attr_t *app_attrs,
        uint8_t num_ext_attr,
        btrc_player_app_ext_attr_t *ext_attrs);

typedef void (* btrc_ctrl_playerapplicationsetting_changed_callback)(tls_bt_addr_t *bd_addr,
        btrc_player_settings_t *p_vals);

typedef void (* btrc_ctrl_track_changed_callback)(tls_bt_addr_t *bd_addr, uint8_t num_attr,
        btrc_element_attr_val_t *p_attrs);

typedef void (* btrc_ctrl_play_position_changed_callback)(tls_bt_addr_t *bd_addr,
        uint32_t song_len, uint32_t song_pos);

typedef void (* btrc_ctrl_play_status_changed_callback)(tls_bt_addr_t *bd_addr,
        btrc_play_status_t play_status);
...
typedef struct
{
     ...
     * Register the BtRc callbacks
     */
    tls_bt_status_t (*init)(btrc_ctrl_callbacks_t *callbacks);
    ...
    tls_bt_status_t (*set_player_app_setting_cmd)(tls_bt_addr_t *bd_addr, uint8_t num_attrib,
            uint8_t *attrib_ids, uint8_t *attrib_vals);

    /** send rsp to set_abs_vol received from target */
    tls_bt_status_t (*set_volume_rsp)(tls_bt_addr_t *bd_addr, uint8_t abs_vol, uint8_t label);
