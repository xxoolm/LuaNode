 ...
 *
 ******************************************************************************/
#ifndef GKI_TARGET_BLE_H
#define GKI_TARGET_BLE_H
...
/* The size of the buffers in pool 2. */
    ...
    #define GKI_BUF2_SIZE               788
#endif

/* The number of buffers in buffer pool 2. */
#ifndef GKI_BUF2_MAX
    #define GKI_BUF2_MAX                6
#endif
...
/* The size of the buffers in pool 3. */
    ...
    #define GKI_BUF3_SIZE               (2048+16)
#endif

/* The number of buffers in buffer pool 3. */
#ifndef GKI_BUF3_MAX
    #define GKI_BUF3_MAX                2
    //200
#endif
...
/* The size of the buffers in pool 4. */
    ...
    #define GKI_BUF4_SIZE               (4200)
#endif

/* The number of buffers in buffer pool 4. */
#ifndef GKI_BUF4_MAX
    #define GKI_BUF4_MAX                (1)
#endif
