...
typedef struct
{
     ...
     */
    tls_bt_status_t (*init)(const btpan_callbacks_t *callbacks);
    /*
     ...
     */
    tls_bt_status_t (*enable)(int local_role);
    /*
     ...
     */
    tls_bt_status_t (*connect)(const tls_bt_addr_t *bd_addr, int local_role, int remote_role);
    /**
     * stop bluetooth pan connection. The result state will be returned by btpan_connection_state_callback
     */
    tls_bt_status_t (*disconnect)(const tls_bt_addr_t *bd_addr);
