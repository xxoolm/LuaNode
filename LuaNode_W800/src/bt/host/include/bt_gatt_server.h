...
typedef void (*characteristic_added_callback)(int status, int server_if,
        tls_bt_uuid_t *uuid, int srvc_handle, int char_handle);
...
typedef void (*descriptor_added_callback)(int status, int server_if,
        tls_bt_uuid_t *uuid, int srvc_handle, int descr_handle);
 ...
 */
typedef void (*request_read_callback)(int conn_id, int trans_id, tls_bt_addr_t *bda,
 ...
 */
typedef void (*request_write_callback)(int conn_id, int trans_id, tls_bt_addr_t *bda,
...
typedef struct
{
    ...
    tls_bt_status_t (*unregister_server)(int server_if);
    ...
    tls_bt_status_t (*add_included_service)(int server_if, int service_handle, int included_handle);
    ...
    tls_bt_status_t (*delete_service)(int server_if, int service_handle);
