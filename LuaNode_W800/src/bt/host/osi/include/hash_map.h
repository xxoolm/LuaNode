...
typedef uint8_t (*hash_map_iter_cb)(hash_map_entry_t *hash_entry, void *context);

typedef uint8_t (*key_equality_fn)(const void *x, const void *y);
...
uint8_t hash_map_is_empty(const hash_map_t *hash_map);
...
uint8_t hash_map_has_key(const hash_map_t *hash_map, const void *key);
...
uint8_t hash_map_set(hash_map_t *hash_map, const void *key, void *data);
...
uint8_t hash_map_erase(hash_map_t *hash_map, const void *key);
