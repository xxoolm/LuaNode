...
uint8_t config_has_section(const config_t *config, const char *section);
...
uint8_t config_has_key(const config_t *config, const char *section, const char *key);
...
// not already exist, this function creates them. |config|, |section|, and |key|
// must not be NULL.
void config_set_bool(config_t *config, const char *section, const char *key, uint8_t value);
...
uint8_t config_remove_section(config_t *config, const char *section);
...
uint8_t config_remove_key(config_t *config, const char *section, const char *key);
...
uint8_t config_save(const config_t *config, const char *filename);
