...
**
*******************************************************************************/
extern void bta_gatts_co_update_handle_range(uint8_t is_add, tBTA_GATTS_HNDL_RANGE *p_hndl_range);
...
**
*******************************************************************************/
extern uint8_t bta_gatts_co_srv_chg(tBTA_GATTS_SRV_CHG_CMD cmd,
...
**
*******************************************************************************/
extern  uint8_t bta_gatts_co_load_handle_range(uint8_t index,
