...
typedef struct
{
    ...
    uint8_t         min_16_digit;       /* TRUE if the pin returned must be at least 16 digits */
} tBTA_DM_PIN_REQ;
...
**
*******************************************************************************/
extern void BTA_DmPinReply(BD_ADDR bd_addr, uint8_t accept, uint8_t pin_len,
                           uint8_t *p_pin);
...
**
*******************************************************************************/
extern void BTA_DmConfirm(BD_ADDR bd_addr, uint8_t accept);
...
extern void BTA_DmAddDevice(BD_ADDR bd_addr, DEV_CLASS dev_class,
                            ...
                            uint8_t is_trusted, uint8_t key_type,
...
**
*******************************************************************************/
extern uint16_t BTA_DmGetConnectionState(BD_ADDR bd_addr);
...
**
*******************************************************************************/
extern void BTA_DmCloseACL(BD_ADDR bd_addr, uint8_t remove_dev, tBTA_TRANSPORT transport);
...
**
*******************************************************************************/
extern void BTA_DmBlePasskeyReply(BD_ADDR bd_addr, uint8_t accept, uint32_t passkey);
...
**
*******************************************************************************/
extern void BTA_DmBleConfirmReply(BD_ADDR bd_addr, uint8_t accept);
...
**
*******************************************************************************/
extern void BTA_DmBleConfigLocalPrivacy(uint8_t privacy_enable);
...
**
*******************************************************************************/
extern void BTA_DmBleEnableRemotePrivacy(BD_ADDR bd_addr, uint8_t privacy_enable);
...
**
*******************************************************************************/
extern void BTA_BleCfgAdvInstData(uint8_t inst_id, uint8_t is_scan_rsp,
...
**
*******************************************************************************/
extern void BTA_DmBleUpdateConnectionParams(BD_ADDR bd_addr, uint16_t min_int,
