...
typedef struct
{
    ...
    uint8_t     is_primary; /* used when attribute type is service */
...
{
    uint16_t conn_id;
    uint8_t congested; /* congestion indicator */
} tBTA_GATTC_CONGEST;
...
{
    uint16_t conn_id;
    uint8_t congested; /* report channel congestion indicator */
} tBTA_GATTS_CONGEST;
...
**
*******************************************************************************/
extern void BTA_GATTC_CancelOpen(tBTA_GATTC_IF client_if, BD_ADDR remote_bda, uint8_t is_direct);
...
**
*******************************************************************************/
extern void BTA_GATTC_ExecuteWrite(uint16_t conn_id, uint8_t is_execute);
...
**
*******************************************************************************/
extern void BTA_GATTC_Listen(tBTA_GATTC_IF client_if, uint8_t start, BD_ADDR_PTR target_bda);
...
**
*******************************************************************************/
extern void BTA_GATTC_Broadcast(tBTA_GATTC_IF client_if, uint8_t start);
...
extern void BTA_GATTS_CreateService(tBTA_GATTS_IF server_if, tBT_UUID *p_service_uuid,
                                    uint8_t inst, uint16_t num_handle, uint8_t is_primary);
...
**
*******************************************************************************/
extern uint8_t BTA_GATTS_HandleValueIndication(uint16_t conn_id, uint16_t attr_id,
        uint16_t data_len,
        uint8_t *p_data,
...
**
*******************************************************************************/
extern void BTA_GATTS_CancelOpen(tBTA_GATTS_IF server_if, BD_ADDR remote_bda, uint8_t is_direct);
...
**
*******************************************************************************/
extern void BTA_GATTS_Listen(tBTA_GATTS_IF server_if, uint8_t start,
