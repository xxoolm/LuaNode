        ...
        tBTA_GATTC_ATTR_TYPE type)
{
    ...
    if(type == BTA_GATTC_ATTR_TYPE_INCL_SRVC)
    {
        ...
        if(type == BTA_GATTC_ATTR_TYPE_CHAR_DESCR)
        {
...
**
*******************************************************************************/
void bta_gattc_get_disc_range(tBTA_GATTC_SERV *p_srvc_cb, uint16_t *p_s_hdl, uint16_t *p_e_hdl, uint8_t is_srvc)
{
...
**
*******************************************************************************/
void bta_gattc_get_gatt_db(uint16_t conn_id, uint16_t start_handle, uint16_t end_handle, tls_btgatt_db_element_t **db, int *count)
{
    tBTA_GATTC_CLCB *p_clcb = bta_gattc_find_clcb_by_conn_id(conn_id);
