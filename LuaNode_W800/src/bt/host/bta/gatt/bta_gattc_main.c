...
**
**
** Returns          uint8_t  : TRUE if queued client request buffer can be immediately released
**                                        else FALSE
**
*******************************************************************************/
uint8_t bta_gattc_sm_execute(tBTA_GATTC_CLCB *p_clcb, uint16_t event, tBTA_GATTC_DATA *p_data)
{
...
**
*******************************************************************************/
uint8_t bta_gattc_hdl_event(BT_HDR *p_msg)
{
