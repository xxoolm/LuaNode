...
static void bta_hf_client_api_enable(tBTA_HF_CLIENT_DATA *p_data)
{
    ...
    wm_memset(&bta_hf_client_cb, 0, sizeof(tBTA_HF_CLIENT_CB));
    /* store callback function */
    bta_hf_client_cb.p_cback = p_data->api_enable.p_cback;
    /* check if mSBC support enabled */
    APPL_TRACE_DEBUG("bta_hf_client_api_enable, (hfpversion)Force msbc_enabled...\r\n");
...
**
*******************************************************************************/
void bta_hf_client_slc_seq(uint8_t error)
{
