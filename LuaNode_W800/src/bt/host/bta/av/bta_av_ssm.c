...
**
*******************************************************************************/
uint8_t bta_av_is_rcfg_sst(tBTA_AV_SCB *p_scb)
{
...
**
*******************************************************************************/
uint8_t bta_av_is_scb_opening(tBTA_AV_SCB *p_scb)
{
...
**
*******************************************************************************/
uint8_t bta_av_is_scb_incoming(tBTA_AV_SCB *p_scb)
{
...
**
*******************************************************************************/
uint8_t bta_av_is_scb_init(tBTA_AV_SCB *p_scb)
{
