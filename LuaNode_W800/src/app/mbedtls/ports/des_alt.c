                          ...
                          unsigned char output[8])
{
    ...
    if (ctx)
    {
        ...
        tls_crypto_des_encrypt_decrypt(pctx, (unsigned char *)input, output, 8, pctx->des3.blocklen);
    }
                          ...
                          unsigned char *output)
{
    ...
    if (ctx)
    {
    	...
    	tls_crypto_des_encrypt_decrypt(pctx, (unsigned char *)input, output, length, 
                           ...
                           unsigned char output[8])
{
    ...
    if (ctx)
    {
        ...
        tls_crypto_3des_encrypt_decrypt(pctx, (unsigned char *)input, output, 8, pctx->des3.blocklen);
    }
                           ...
                           unsigned char *output)
{
    ...
    if (ctx)
    {
    	...
    	tls_crypto_3des_encrypt_decrypt(pctx, (unsigned char *)input, output, length, 
    	mode == MBEDTLS_DES_ENCRYPT ? CRYPTO_WAY_ENCRYPT : CRYPTO_WAY_DECRYPT);
